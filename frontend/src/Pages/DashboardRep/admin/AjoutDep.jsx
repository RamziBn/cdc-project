...
const AjoutDep = () => {
    ...
    const handleNavigate = () => {
        navigate('/dashboard/manage-departement'); // Navigation vers la page souhaitée
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/dashboard/manage-departement');
        } catch (error) {
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-center text-4xl font-bold mb-4">Ajouter un <span className="text-secondary">Departement</span></h1>
