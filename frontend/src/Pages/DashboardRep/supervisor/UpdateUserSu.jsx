...
const UpdateUserSu = () => {
    ...
    const handleNavigate = () => {
        navigate('/dashboard/manager-usersu'); // Navigation vers la page souhaitée
      };
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/dashboard/manager-usersu'); // Redirige vers la nouvelle page
        } catch (error) {
    ...
    return (
        <div>
            <h1 className='text-center text-4xl font-bold mt-5'>
                Update Su : <span className='text-secondary'>{userCredentials?.name}</span>
            </h1>
