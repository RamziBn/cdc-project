    ...
    return (
        <div className='p-6'>
            <h1 className='text-3xl font-bold text-center mb-6'>
                Manage <span className='text-red-500'>Salaries</span> Full Access
            </h1>
            ...
            <div className="flex justify-between mb-4">
                ...
                <button 
                    onClick={() => navigate('/dashboard/add-usersu')} 
                                ...
                                <table className='min-w-full bg-white'>
                                    <thead className='bg-gray-100'>
                                        <tr>
                                            ...
                                            <th className='py-2 px-4 text-left text-gray-800 font-medium'>Role</th>
                                            ...
                                            <th className='py-2 px-4 text-center text-gray-800 font-medium'>Update</th>
                                            <th className='py-2 px-4 text-center text-gray-800 font-medium'>Delete</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {filteredUsers.map((user, idx) => (
                                            <tr
                                                ...
                                                <td className='whitespace-nowrap px-6 py-4 text-center'>
                                                    <span
                                                        onClick={() => navigate(`/dashboard/update-usersu/${user._id}`)}
