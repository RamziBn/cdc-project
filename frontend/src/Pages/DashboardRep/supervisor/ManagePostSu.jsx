    ...
    return (
        <div>
            <h1 className='text-center text-4xl font-bold my-7'>
                Manage <span className='text-secondary'>Posts</span> Full Access
            </h1>
            <div className='flex justify-center mb-4'>
                <button
                    onClick={() => navigate('/dashboard/add-postsu')}
                                ...
                                <tbody>
                                    {currentItems.map((post, idx) => (
                                        <tr
                                            ...
                                            <td className='whitespace-nowrap px-6 py-4 font-medium'>{indexOfFirstItem + idx + 1}</td>
                                            ...
                                            <td className='whitespace-nowrap px-6 py-4'>
                                                <span
                                                    onClick={() => navigate(`/dashboard/update-postsu/${post._id}`)}
