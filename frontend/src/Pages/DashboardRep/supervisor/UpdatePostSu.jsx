...
const UpdatePostSu = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/dashboard/manage-postsu'); // Redirige vers la nouvelle page
        } catch (error) {
    ...
    return (
        <div>
            <h1 className='text-center text-4xl font-bold mt-5'>
                Update Post Su: <span className='text-secondary'>{postData?.nom || 'Unknown Post'}</span>
            </h1>
