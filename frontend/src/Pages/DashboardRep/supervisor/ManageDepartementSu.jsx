    ...
    return (
        <div>
            <h1 className='text-center text-4xl font-bold my-7'>
                Manage <span className='text-secondary'>Departments </span> Full Access
            </h1>
            <div className='flex justify-end mb-4'>
                <button
                    onClick={() => navigate('/dashboard/add-depsu')}
                                ...
                                <tbody>
                                    {departements.map((departement, idx) => (
                                        <tr
                                            ...
                                            <td className='whitespace-nowrap px-6 py-4'>
                                                <span
                                                    onClick={() => navigate(`/dashboard/update-departementsu/${departement._id}`)}
...
export default ManageDepartementSu;
