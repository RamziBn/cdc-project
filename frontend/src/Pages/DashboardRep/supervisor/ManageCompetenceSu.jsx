...
const ManageCompetenceSu = () => {
    ...
    const filteredAndSortedCompetences = [...competences]
        .filter(competence => {
            ...
            return withinDateRange && withinNiveauRange && (
    ...
    return (
        <div className='p-6'>
            <h1 className='text-3xl font-bold text-center mb-6'>
                Gestion des <span className='text-red-500'>Compétences</span> Full Access
            </h1>
            <div className='flex justify-between mb-4'>
                <button
                    onClick={() => navigate('/dashboard/add-competencesu')}
                            ...
                            {currentItems.map(competence => (
                                <tr key={competence._id} className='border-t'>
                                    ...
                                    <td className='py-2 px-4 text-center flex justify-center space-x-2'>
                                        ...
                                        <button
                                            onClick={() => navigate(`/dashboard/update-competencesu/${competence._id}`)}
...
export default ManageCompetenceSu;
